...
void AnimationDrone() {
	if (Animdrone) {
		static float direction = 0.8f;
		//rotdrone += 0.1;
		rothelices += 0.4;
		ydronemovement += direction;

		if (ydronemovement >= 23.0f) {
			direction = -0.8f;
...
int main() {
	...
	Model CabezaGirl("Models/Personas/Persona111/Cabeza/Cabeza.obj");
	Model GirlBrazoDer("Models/Personas/Persona111/Brazo_derecho/BrazoDerecho.obj");
	Model GirlBrazoIzq("Models/Personas/Persona111/Brazo_izquierdo/BrazoIzquierdo.obj");
	Model GirlPiernaDer("Models/Personas/Persona111/Pierna_derecha/PiernaDerecha.obj");
	Model GirlPiernaIzq("Models/Personas/Persona111/Pierna_izquierda/PiernaIzquierda.obj");
	Model Torso("Models/Personas/Persona111/Torso/Torso.obj");
	Model GirlTorso("Models/Personas/Persona111/Torso_cabeza/TorsoCabeza.obj");

	//PERSONAS

	Model persona2("Models/Personas/Persona2/12-1.obj");
	Model persona3("Models/Personas/Persona3/12-2.obj");
	Model persona4("Models/Personas/Persona4/12-3.obj");
	Model persona5("Models/Personas/Persona5/12-4.obj");
	Model persona6("Models/Personas/Persona6/12-5.obj");
	Model persona7("Models/Personas/Persona7/12-6.obj");
	Model persona8("Models/Personas/Persona8/12-7.obj");
	Model persona9("Models/Personas/Persona9/Persona9.obj");

	Model banio("Models/Banio2/banio2.obj");
...
// ####################################################################################################################
		...
		model = glm::translate(model, glm::vec3(50.0f, 2.7f, -12.0f));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(10.0f, 0.21f, -10.0f));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(6.0f, 0.21f, -10.0f));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(6.0f, 0.21f, -10.3f));
		model = glm::rotate(model, glm::radians(-45.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(6.0f, 0.21f, -10.6f));
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(6.0f, 0.21f, -10.9f));
		model = glm::rotate(model, glm::radians(-45.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona4.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(6.0f, 0.21f, -11.2f));
		model = glm::rotate(model, glm::radians(-45.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona6.Draw(staticShader);

		//Personas en el escenario ultima fila

		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(18.0f, 0.21f, -0.5f));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(18.0f, 0.21f, -0.8f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona2.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(18.0f, 0.21f, -1.1f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(18.0f, 0.21f, -1.4f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(18.0f, 0.21f, -1.7f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona8.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(18.0f, 0.21f, -2.0f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.0002f, 0.0002f, 0.0002f));
		staticShader.setMat4("model", model);
		persona9.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(18.0f, 0.21f, -2.3f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona2.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(18.0f, 0.21f, -2.6f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona8.Draw(staticShader);

		//Personas en el escenario fila en medio

		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(19.0f, 0.21f, -0.65f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona7.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(19.0f, 0.21f, -0.95f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona8.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(19.0f, 0.21f, -1.25f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.0002f, 0.0002f, 0.0002f));
		staticShader.setMat4("model", model);
		persona9.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(19.0f, 0.21f, -1.55f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona2.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(19.0f, 0.21f, -1.85f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona8.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(19.0f, 0.21f, -2.15f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.0002f, 0.0002f, 0.0002f));
		staticShader.setMat4("model", model);
		persona9.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(19.0f, 0.21f, -2.45f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona2.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(19.0f, 0.21f, -2.75f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona8.Draw(staticShader);

		//Personas en el escenario primera fila

		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(20.0f, 0.21f, -0.5f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.0002f, 0.0002f, 0.0002f));
		staticShader.setMat4("model", model);
		persona9.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(20.0f, 0.21f, -0.8f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona2.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(20.0f, 0.21f, -1.1f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona8.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(20.0f, 0.21f, -1.4f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona7.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(20.0f, 0.21f, -1.7f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona8.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(20.0f, 0.21f, -2.0f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.0002f, 0.0002f, 0.0002f));
		staticShader.setMat4("model", model);
		persona9.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(20.0f, 0.21f, -2.3f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona2.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(20.0f, 0.21f, -2.6f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona8.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(13.0f, 0.21f, -9.3f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.0002f, 0.0002f, 0.0002f));
		staticShader.setMat4("model", model);
		persona9.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(13.0f, 0.21f, -9.6f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona2.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(13.0f, 0.21f, -9.9f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona8.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(13.0f, 0.21f, -10.2f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona7.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(13.0f, 0.21f, -10.5f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona8.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(13.0f, 0.21f, -10.8f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.0002f, 0.0002f, 0.0002f));
		staticShader.setMat4("model", model);
		persona9.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(13.0f, 0.21f, -11.1f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona2.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(13.0f, 0.21f, -11.4f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona8.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(13.0f, 0.21f, -11.7f));
		model = glm::rotate(model, glm::radians(45.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona7.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(25.0f, -0.2f, -2.0f));
		model = glm::rotate(model, glm::radians(0.0f), glm::vec3(0.0f, 1.0f, 0.0));
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(29.0f, -0.2f, -2.0f));
		model = glm::rotate(model, glm::radians(0.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.0001f, 0.0001f, 0.0001f));
		staticShader.setMat4("model", model);
		banio.Draw(staticShader);
		...
		//Personas comprando boletos

		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(14.0f, 0.21f, -9.55f));
		model = glm::rotate(model, glm::radians(60.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.0002f, 0.0002f, 0.0002f));
		staticShader.setMat4("model", model);
		persona9.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(13.7f, 0.21f, -9.55f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona2.Draw(staticShader);
		...
		//Personas arriba de la cafeteria

		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(5.0f, 0.7f, -10.3f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona3.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(5.0f, 0.7f, -10.6f));
		model = glm::rotate(model, glm::radians(-45.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona4.Draw(staticShader);
		...
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(5.0f, 0.7f, -10.9f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.002f, 0.002f, 0.002f));
		staticShader.setMat4("model", model);
		persona5.Draw(staticShader);
		...
		//Arbol
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(27.5f, -0.15f, -2.0f));
		model = glm::rotate(model, glm::radians(0.0f), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.03f, 0.03f, 0.03f));
		staticShader.setMat4("model", model);
		arbol.Draw(staticShader);
